...
import ManageConsumerNotifications from "./ManageConsumerNotifications";

const ConsumerNotificationConatiner = ({
...
export default ConsumerNotificationConatiner;
