...
import { validationSchemaCorporate } from "./ValiadtionSchemaForRegister";
  ...
  return (
    <div className="mt-4 flex flex-grow">
      <Formik
        ...
        validationSchema={validationSchemaCorporate}
        onSubmit={async (values: IRegistrationFormValues, { resetForm }) => {
          const response = await SignUp({ ...values, type: 4 });
          if (!response.error) {
