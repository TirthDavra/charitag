...
const ConsumerNotificationsBell = () => {
        ...
        <Popover>
          <PopoverTrigger>
            <div className="relative">
              <Bell
                className="mx-2 h-[22px] w-[22px] text-sidebar_icon_color"
          ...
          <PopoverContent className="mt-6 w-fit">
            {/* <NotificationsModal
              data={data}
              isLoading={isLoading}
              redirectUrl="/consumer/notifications"
            /> */}
          </PopoverContent>
        </Popover>
      </div>
...
export default ConsumerNotificationsBell;
