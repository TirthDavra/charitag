"use client";
import { INotificationsResponse } from "@/api/common/types";
...
import CorporateNotificationModal from "./CorporateNotificationModal";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faBellSlash } from "@fortawesome/free-solid-svg-icons";

const ManageCorporateNotifications = ({
  ...
  const notificationData1 = allNotificationsData.notifications;

  const [notificationData, setNotificationData] = useState(notificationData1);
  ...
  useEffect(() => {
    setNotificationData(notificationDataProp.data);
    dispatch(
      setNotification({
  ...
  return (
    <div>
      ...
      <CorporateNotificationModal data={notificationData} />
      <div className="pt-14">
        <ShowMore
          page={curPage}
...
export default ManageCorporateNotifications;
