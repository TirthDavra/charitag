import { getCorporateRoles } from "@/api/corporation/manageCorporateStaff";
import ButtonPrimary from "@/components/common/ButtonPrimary";
import CorporateRolesTable from "@/components/corporate/ManageStaff/ManageCorporateRoles/CorporateRolesTable";
...
const CorporateRoles = async ({
  ...
  const roles = await getCorporateRoles({
  ...
  return (
    <div>
      <div>
        ...
        />
        <CorporateRolesTable roles={roles.data} />
        <TablePagination
