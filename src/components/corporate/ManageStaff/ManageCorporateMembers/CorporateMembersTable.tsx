...
import { deleteCorporateMember, updateCorporateMemberStatus } from "@/api/corporation/manageCorporateStaff";
...
const CorporateMembersTable = React.memo(
            ...
            openModal({
                content: (
                    <ActionContent
                        ...
                        onCancel={closeModal}
                        onOk={async () => {
                            const response = await deleteCorporateMember(id);
                            if (!response.error) {
                                setNewData(
                                    produce((draft) => {
                                    ...
                                    openModal({
                                        content: (
                                            <ActionContent
                                                ...
                                                onCancel={closeModal}
                                                onOk={async () => {
                                                    const response = await updateCorporateMemberStatus({
...
CorporateMembersTable.displayName = "CorporateMembersTable";
