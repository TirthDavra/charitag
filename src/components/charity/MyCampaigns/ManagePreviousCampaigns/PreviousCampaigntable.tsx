...
import { ICharityCampaign } from "@/api/charity/types";
import productImg from "@images/productImage.png";
...
import { deleteCharityCampaigns } from "@/api/charity/charityCampaign";
...
const PreviousCampaigntable = React.memo(
  ({ campaign, className, tableHeaders = true }: DataTableProps) => {
    ...
    const campaignColumsDef: ColumnDef<ICharityCampaign>[] = [
      {
        accessorKey: "image",
        header: () => {
          return (
      ...
      },
      {
        ...
        cell: ({ cell }) => {
          return (
            <div className="min-w-[150px] text-sm text-merchant_text_color_blue">
          ...
          return (
            <div className="flex min-w-[500px] gap-1">
              <Link
                ...
                type="button"
              >
                View updates and donors /
              </Link>
              <Link
                href={`my-campaigns/add-campaigns?campaignId=${cell.row.original.id}&prev_campaign=true`}
                className="text-merchant_text_color_blue"
                type="button"
              >
                Reluanch /
              ...
              <Link
                href={`my-campaigns/add-campaign?campaignId=1`}
                className="text-merchant_text_color_blue"
                type="button"
              >
                Downlaod /
                    ...
                    content: (
                      <ActionContent
                        ...
                        onOk={async () => {
                          ...
                          const response = await deleteCharityCampaigns(
...
PreviousCampaigntable.displayName = "PreviousCampaigntable";
export default PreviousCampaigntable;
