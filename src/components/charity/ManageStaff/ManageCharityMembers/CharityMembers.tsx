import { getCharityMembers } from "@/api/charity/charityManageStaff";
import CharityMembersTable from "@/components/charity/ManageStaff/ManageCharityMembers/CharityMembersTable";
...
const CharityMembers = async ({
  ...
  const members = await getCharityMembers({
  ...
  return (
    <div>
      ...
      />
      <CharityMembersTable members={members.data || []} />
      <TablePagination
