...
import ManageNotifications from "../../common/Notifications/ManageNotifications";
import ShowMore, {
  ShowMoreHandle,
...
const MerhantNotificationsContainer = ({
...
export default MerhantNotificationsContainer;
