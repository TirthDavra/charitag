...
import Roles from "@/components/merchant/ManageStaff/ManageRoles/Roles";
import Members from "@/components/merchant/ManageStaff/ManageMembers/Members";
  ...
  return (
    <div>
      ...
      {context.searchParams.roles === "false" ? (
        <Members searchParams={context.searchParams} />
      ) : (
        <Roles searchParams={context.searchParams} />
      )}
    </div>
  );
};
